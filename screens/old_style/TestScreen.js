...
export default class TestScreen extends React.Component {
  ...
  setAnswer(number) {
    ...
    if (this.state.answers[this.state.questionNumber].userAnswer != null) {
      ...
      if (this.state.questionNumber < 9 && EMPTY_ANSWER != -1) {
        ...
        this.setState((prevState) => ({
          questionNumber: prevState.answers.findIndex(
  ...
  getQuestionStatusColor(number) {
    if (number == this.state.questionNumber)
      return COLORS.questionStatusActiveBackground;
    if (this.state.answers[number].userAnswer == null)
      return COLORS.questionStatusDefaultBackground;
    if (
      ...
      >
        ...
        >
          ...
          <Text
            style={{
              fontSize: 30,
              color: this.state.examStatus == "passed" ? "green" : "red",
            }}
          >
            {this.state.examStatus == "passed"
              ? "Экзамен сдан"
        ...
        <Text style={styles.title}>
          Категория {this.currentCategory.substr(0, 1)}. Билет №
          {this.state.ticketNumber + 1} - {this.state.timer}
        </Text>
              ...
              >
                <View
                  style={{
                    width: 30,
                    height: 25,
                    backgroundColor: this.getQuestionStatusColor(index),
                  }}
                >
        ...
        <ScrollView style={{ height: "50%" }}>
          ...
          {this.getQuestionItem().answers.map((answer, index) => (
            ...
            >
              <View
                style={{
                  backgroundColor: this.getAnswerStatusColor(index),
                  paddingVertical: 8,
                  marginVertical: 5,
                  paddingHorizontal: 20,
                }}
