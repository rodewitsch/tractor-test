  ...
  refreshState() {
    AsyncStorage.getItem("settings").then((data) => {
      if (data) {
        ...
        if (!this.state.settings.oldStyle)
      ...
      <SafeAreaView style={styles.container}>
        <View style={{ width: "100%", height: "100%" }}>
          ...
          <Text style={styles.title}>
            Тесты по правилам технической эксплуатации для получения профессии
            тракториста-машиниста категорий A,{"\u00A0"}B,{"\u00A0"}D,{"\u00A0"}
            E,{"\u00A0"}F
          </Text>
          ...
          >
            <TouchableOpacity
              onPress={() => this.refs.about.open()}
              style={{ height: 40, width: 40 }}
            >
              <Icon
                style={{ fontSize: 35, color: COLORS.settingsButtonColor }}
            ...
            <TouchableOpacity onPress={() => this.refs.settings.open()}>
              <Icon
                style={{
                  fontSize: 35,
                  color: COLORS.settingsButtonColor,
                  marginLeft: 10,
                }}
                name="md-settings"
              />
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <Item
                parent={this}
                ticketsModal={this.refs.tickets}
                requestTicketNumber={this.state.settings.requestTicketNumber}
